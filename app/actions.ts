  ...
  const html = `
    <div style="font-family: ui-sans-serif, system-ui, sans-serif; color: #0a0a0a; max-width: 640px; margin: 0 auto;">
      ...
      <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
        ...
        <tr><td style="padding: 8px 0; color: #555; vertical-align: top;">Options</td><td>${data.addonsLabels.length ? data.addonsLabels.map(safe).join(", ") : "—"}</td></tr>
        <tr><td colspan="2" style="padding: 16px 0 4px 0; color: #555; border-top: 1px solid #eee;">Message</td></tr>
        <tr><td colspan="2" style="white-space: pre-wrap;">${safe(data.message || "—")}</td></tr>
