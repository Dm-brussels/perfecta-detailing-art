...
export function Wordmark({
  ...
  return (
    <div className={`flex flex-col items-start ${color} ${className}`}>
      <span className="display-lockup whitespace-nowrap text-[0.78rem] sm:text-sm leading-none">
        {t.common.brandName}
      </span>
      <span
        aria-hidden
      ...
      />
      <span className="mt-1 display-lockup whitespace-nowrap text-[0.55rem] sm:text-[0.6rem] tracking-[0.32em] opacity-80">
