    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col justify-end px-6 pb-16 pt-32 sm:px-8 lg:pb-24 lg:pt-40">
        ...
        >
          ...
          <h1 className="mt-6 font-display text-5xl font-light leading-[1.02] tracking-tight text-white text-balance sm:text-6xl lg:text-[5.5rem]">
            {t.hero.title1}
            <br />
